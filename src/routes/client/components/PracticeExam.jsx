...
export default function PracticeExam() {
  return (
    <>
      <div className="flex gap-5 bg-white rounder-lg mt-5 shadow-md p-5 rounded-lg items-center pl-10 pr-10">
        <div className="w-1/2">
            ...
            <div className="mt-5 mb-3 pt-3 pb-3 pl-6 pr-6 rounded-lg bg-blue-400 text-white hover:bg-blue-500 duration-300 cursor-pointer w-fit">
